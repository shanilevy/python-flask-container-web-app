        ...
        stage('Deploy to GKE') {
            ...
            steps {
                ...
                sh '''
                        ...
                        sed -i 's|MONGO_CONNECTION_STRING|${env.MONGO_STRING}|' kubernetes_private.yaml
                        sed -i 's|DB_NAME|${env.MONGO_DB}|' kubernetes_private.yaml
                        sed -i 's|COLLECTION_NAME|${env.MONGO_COLL}|' kubernetes_private.yaml
